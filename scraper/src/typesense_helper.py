    ...
    def create_tmp_collection(self):
        ...
        self.typesense_client.collections.create({
            ...
            'fields': [
                ...
                {'name': 'hierarchy.lvl0', 'type': 'string', 'facet': True, 'optional': True, 'locale': 'ru'},
                {'name': 'hierarchy.lvl1', 'type': 'string', 'facet': True, 'optional': True, 'locale': 'ru'},
                {'name': 'hierarchy.lvl2', 'type': 'string', 'facet': True, 'optional': True, 'locale': 'ru'},
                {'name': 'hierarchy.lvl3', 'type': 'string', 'facet': True, 'optional': True, 'locale': 'ru'},
                {'name': 'hierarchy.lvl4', 'type': 'string', 'facet': True, 'optional': True, 'locale': 'ru'},
                {'name': 'hierarchy.lvl5', 'type': 'string', 'facet': True, 'optional': True, 'locale': 'ru'},
                {'name': 'hierarchy.lvl6', 'type': 'string', 'facet': True, 'optional': True, 'locale': 'ru'},
